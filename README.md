...
Use 'help' to learn the commands needed, for example 'ls' to list all the documents in the folder, 'cd' to change to the subfolder where we can access the challenge and 'edit' python/java file.
